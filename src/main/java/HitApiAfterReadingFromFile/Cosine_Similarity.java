...
public class Cosine_Similarity {
    ...
    public double Cosine_Similarity_Score(String Text1, String Text2)
    {
        ...
        sim_score = ((VectAB * 1.0)/(Math.sqrt(VectA_Sq)*Math.sqrt(VectB_Sq)));
    ...
    public static void main(String[] args)
    {
        ...
        double sim_score = cs1.Cosine_Similarity_Score("Musician Khayyam Critical, Admitted to ICU in Mumbai Hospital", "Musician Khayyam's condition critical, treatment underway in Mumbai hospital");
        System.out.println("Cosine similarity score = "+sim_score);
        System.out.println("time take :: " + (System.currentTimeMillis() - current_time));
    }
}